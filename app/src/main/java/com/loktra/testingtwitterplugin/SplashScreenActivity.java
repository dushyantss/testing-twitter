...
import com.loktra.testingtwitterplugin.helpers.Constants;
import com.loktra.testingtwitterplugin.helpers.NetworkingHelper;
import com.loktra.testingtwitterplugin.helpers.PreferenceHelper;
    ...
    private void updateUserData() {
        ...
        call.enqueue(new Callback<User>() {
            ...
            public void success(Result<User> userResult) {
                ...
                CurrentUser currentUser = new CurrentUser(user.idStr,
                        user.name,
